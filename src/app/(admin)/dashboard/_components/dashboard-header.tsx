  ...
  return (
    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between pb-6 border-b border-slate-200">
      ...
      <div className="flex items-center gap-3">
        ...
        <Button asChild className="bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 text-white rounded-xl px-5 py-2 font-semibold shadow-md hover:shadow-lg transition-all duration-200">
