...
export async function getPortfolioStatsCustomerV1(userId: string): Promise<PortfolioStats | null> {
  try {
    ...
    console.error("Error fetching portfolio stats (customer v1):", error);
    return null;
  }
}
